...
import com.jiahe.intellipichub.mapper.SpaceUserMapper;
...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    public void validSpaceUser(SpaceUser spaceUser, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(user == null, ErrorCode.NOT_FOUND_ERROR, "User is not exist");
            Space space = spaceService.getById(spaceId);
            ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR, "Space is not exist");
        }
        // 不是添加，那就是管理员修改，修改角色，校验空间角色
