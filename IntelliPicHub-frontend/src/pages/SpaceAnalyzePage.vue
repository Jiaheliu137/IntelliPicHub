<template>
  <div id="spaceAnalyzePage">
    <h2>Spcae and PictureHub amalyze -
      <span v-if="queryAll"> All pictures </span>
      <span v-else-if="queryPublic"> Public pictures</span>
      <span v-else>
      <a :href="`/space/${spaceId}`" target="_blank">spaceId：{{ spaceId }}</a>
    </span>
    </h2>
