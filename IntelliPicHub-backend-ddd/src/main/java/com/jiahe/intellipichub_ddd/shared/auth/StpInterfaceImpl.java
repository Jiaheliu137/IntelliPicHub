package com.jiahe.intellipichub_ddd.shared.auth;
...
import static com.jiahe.intellipichub_ddd.domain.user.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceId == null) {
            ...
            Picture picture = pictureApplicatioinService.lambdaQuery()
