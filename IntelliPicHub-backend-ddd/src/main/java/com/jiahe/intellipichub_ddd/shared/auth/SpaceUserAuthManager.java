...
import com.jiahe.intellipichub_ddd.shared.auth.model.SpaceUserAuthConfig;
import com.jiahe.intellipichub_ddd.shared.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    /**
     * 获取权限列表的方法，注意要区分公共图库、私有空间和团队空间，对于有权限的情况，可以返回 “管理员权限” 列表
     * @param space
     * @param loginUser
     * @return
     */
