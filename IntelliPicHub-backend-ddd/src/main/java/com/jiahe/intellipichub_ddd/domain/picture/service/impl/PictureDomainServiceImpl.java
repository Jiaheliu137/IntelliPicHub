package com.jiahe.intellipichub_ddd.domain.picture.service.impl;
...
import com.jiahe.intellipichub_ddd.infrastructure.manager.upload.FilePictureUpload;
import com.jiahe.intellipichub_ddd.infrastructure.manager.upload.PictureUploadTemplate;
import com.jiahe.intellipichub_ddd.infrastructure.manager.upload.UrlPictureUpload;
...
import com.jiahe.intellipichub_ddd.infrastructure.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.jiahe.intellipichub_ddd.utils.ColorSimilarUtils;
...
//            }
        ...
        transactionTemplate.execute(status -> {
            // 插入数据
            boolean result = pictureRepository.saveOrUpdate(picture); // 根据是否有id来决定是更新还是插入
        ...
        for (Element imgElement : imgElementList) {
            ...
            try {
                ...
                if (pictureVO != null && pictureVO.getId() != null) {
                    ...
                    // 只更新非空字段
                    boolean updateResult = pictureRepository.updateById(picture);
                    if (updateResult) {
