...
import com.jiahe.intellipichub_ddd.shared.auth.annotation.SaSpaceCheckPermission;
...
import com.jiahe.intellipichub_ddd.domain.picture.valueobject.PictureReviewStatusEnum;
...
import com.jiahe.intellipichub_ddd.infrastructure.api.aliyunai.AliYunAiApi;
import com.jiahe.intellipichub_ddd.infrastructure.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.jiahe.intellipichub_ddd.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.jiahe.intellipichub_ddd.infrastructure.api.imagesearch.ImageSearchApiFacade;
...
import com.jiahe.intellipichub_ddd.interfaces.assembler.PictureAssembler;
import com.jiahe.intellipichub_ddd.interfaces.dto.picture.*;
import com.jiahe.intellipichub_ddd.interfaces.vo.picture.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<PictureVO> uploadPicture(
        ...
        PictureVO pictureVO = pictureApplicatioinService.uploadPicture(multipartFile, pictureUploadRequest, loginUser);
    ...
    public BaseResponse<PictureVO> uploadPictureByUrl(
        ...
        PictureVO pictureVO = pictureApplicatioinService.uploadPicture(fileUrl, pictureUploadRequest, loginUser);
        return ResultUtils.success(pictureVO);
    }
    ...
    public BaseResponse<Boolean> deletePicture(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        pictureApplicatioinService.deletePicture(deleteRequest.getId(), loginUser);
    ...
    public BaseResponse<Boolean> updatePicture(@RequestBody PictureUpdateRequest pictureUpdateRequest, HttpServletRequest request) {
        ...
        // 数据校验
        pictureApplicatioinService.validPicture(picture);
        // 判断是否存在
        long id = pictureUpdateRequest.getId();
        Picture oldPicture = pictureApplicatioinService.getById(id);
        ThrowUtils.throwIf(oldPicture == null, ErrorCode.NOT_FOUND_ERROR);
        // 插入数据库之前补充审核参数
        User loginUser = userApplicationService.getLoginUser(request);
        pictureApplicatioinService.fillReviewParams(picture, loginUser);
        // 操作数据库
        boolean result = pictureApplicatioinService.updateById(picture);
    ...
    public BaseResponse<Picture> getPictureById(long id, HttpServletRequest request) {
        ...
        // 查询数据库
        Picture picture = pictureApplicatioinService.getById(id);
    ...
    public BaseResponse<PictureVO> getPictureVOById(long id, HttpServletRequest request) {
        ThrowUtils.throwIf(id <= 0, ErrorCode.PARAMS_ERROR);
        // 这里不用考虑用户是否可以通过id查看未过审的图片，因为这个id用户是拿不到的
        // 查询数据库
        Picture picture = pictureApplicatioinService.getById(id);
        ThrowUtils.throwIf(picture == null, ErrorCode.NOT_FOUND_ERROR);
        // 空间权限校验
        ...
        PictureVO pictureVO = pictureApplicatioinService.getPictureVO(picture, request);
    ...
    public BaseResponse<Page<Picture>> listPictureByPage(@RequestBody PictureQueryRequest pictureQueryRequest) {
        ...
        // 查询数据库
        Page<Picture> picturePage = pictureApplicatioinService.page(new Page<>(current, size),
                pictureApplicatioinService.getQueryWrapper(pictureQueryRequest));
...
//            }
        ...
        Page<Picture> picturePage = pictureApplicatioinService.page(new Page<>(current, size),
                pictureApplicatioinService.getQueryWrapper(pictureQueryRequest));
        // 获取封装类
        return ResultUtils.success(pictureApplicatioinService.getPictureVOPage(picturePage, request));
    }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        Page<Picture> picturePage = pictureApplicatioinService.page(new Page<>(current, size),
                pictureApplicatioinService.getQueryWrapper(pictureQueryRequest));
        Page<PictureVO> pictureVOPage = pictureApplicatioinService.getPictureVOPage(picturePage, request);
    ...
    public BaseResponse<Boolean> editPicture(@RequestBody PictureEditRequest pictureEditRequest, HttpServletRequest request) {
        ...
        pictureApplicatioinService.editPicture(pictureEntity, loginUser);
    ...
    public BaseResponse<Boolean> doPictureReview(@RequestBody PictureReviewRequest pictureReviewRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        pictureApplicatioinService.doPictureReview(pictureReviewRequest, loginUser);
        return ResultUtils.success(true);
    }
    ...
    public BaseResponse<Integer> uploadPictureByBatch(@RequestBody PictureUploadByBatchRequest pictureUploadByBatchRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        int uploadCount = pictureApplicatioinService.uploadPictureByBatch(pictureUploadByBatchRequest, loginUser);
    ...
    public BaseResponse<List<ImageSearchResult>> searchPictureByPicture(@RequestBody SearchPictureByPictureRequest searchPictureByPictureRequest) {
        ...
        Picture oldPicture = pictureApplicatioinService.getById(pictureId);
        ThrowUtils.throwIf(oldPicture == null, ErrorCode.NOT_FOUND_ERROR);
    ...
    public BaseResponse<List<PictureVO>> searchPictureByColor(@RequestBody SearchPictureByColorRequest searchPictureByColorRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        List<PictureVO> result = pictureApplicatioinService.searchPictureByColor(spaceId, picColor, loginUser);
    ...
    public BaseResponse<Boolean> editPictureByBatch(@RequestBody PictureEditByBatchRequest pictureEditByBatchRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        pictureApplicatioinService.editPictureByBatch(pictureEditByBatchRequest, loginUser);
        return ResultUtils.success(true);
    }
    ...
    public BaseResponse<CreateOutPaintingTaskResponse> createPictureOutPaintingTask(
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        CreateOutPaintingTaskResponse response = pictureApplicatioinService.createPictureOutPaintingTask(createPictureOutPaintingTaskRequest, loginUser);
